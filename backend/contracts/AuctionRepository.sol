 ...
 * This contracts allows auctions to be created for NFTs
...
contract AuctionRepository {
    ...
    modifier isOwner(uint256 _auctionId) {
        required(auctions[_auctionId].owner == msg.sender);
        _;
    }
    ...
    /**
     * @dev Gets the bid counts of given auction
     ...
     * @param _auctionTitles string containing auction title
     ...
     * @dev Bidder is reunded with the initial amount
